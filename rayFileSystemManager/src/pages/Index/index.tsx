...
const filePathImage = `${fileRoot}/test.png`
...
const Index: FC = () => {
  ...
  return (
    <View className={styles['container']}>
      ...
      <Button type="primary" className={styles.btn} onClick={readFileImage}>
        读取写入图片
      </Button>
    </View>
  )
