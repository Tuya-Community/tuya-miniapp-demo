...
class Index extends Component {
  ...
  updateCircle = () => {
    let pos1 = generateRandomPoint(this.state.latitude, this.state.longitude, 1000)
    let pos2 = generateRandomPoint(this.state.latitude, this.state.longitude, 1000)
    let circles = [
      {
        ...pos1,
  ...
  getPolygons = (latitude, longitude, radiusInMeters = 1000, numberOfPoints = 1) => {
  ...
  updatePolygons = () => {
    let polygons = this.getPolygons(this.state.latitude, this.state.longitude, 3000, 4)
    this.setState({
      polygons: polygons,
    })
  }
