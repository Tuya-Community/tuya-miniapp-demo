...
class Index extends Component {
	...
	renderScrollView = Array.from({ length: 10 }, (_, index) => (
		<View key={index}>
			<View
				style={{ height: "100px", background: "#f4bfbf", width: "100%" }}
			></View>
			<View
				style={{ height: "100px", background: "#ffd9c0", width: "100%" }}
			></View>
			<View
				style={{ height: "100px", background: "#faf0d7", width: "100%" }}
			></View>
			<View
				style={{ height: "100px", background: "#8cc0de", width: "100%" }}
			></View>
		</View>
	));
