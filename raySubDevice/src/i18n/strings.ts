export default {
  en: {
    device_info: 'SubDevice',
    getSubDeviceInfoList: 'getSubDeviceInfoList',
    onSubDeviceAdded: 'onSubDeviceAdded',
  ...
  zh: {
    device_info: '子设备控制',
    getSubDeviceInfoList: '获取子设备列表',
    onSubDeviceAdded: '监听子设备添加事件',
    onSubDeviceInfoUpdate: '监听子设备信息变更事件',
    onSubDeviceRemoved: '监听子设备移除事件',
